      ...
      function Library:InitEsp(Data)
          ...
          do
              ...
              Objects["HealthBarGradient"] = self:CreateObjects("UIGradient", {
                  ...
                  Rotation = 90,
                  Color = ColorSequence.new({
                      ColorSequenceKeypoint.new(0, Config['Bars']['Health Bar']['Top']),
                      ColorSequenceKeypoint.new(0.5, Config['Bars']['Health Bar']['Mid']),
                      ColorSequenceKeypoint.new(1, Config['Bars']['Health Bar']['Bot']),
                  }),
                  Transparency = NumSeq({NumKey(0, 0), NumKey(1, 0)}),
              })
              ...
              Objects["ArmorBarGradient"] = self:CreateObjects("UIGradient", {
                  ...
                  Rotation = 0,
                  Color = ColorSequence.new({
                      ColorSequenceKeypoint.new(0, Config['Bars']['Armor Bar']['Top']),
                      ColorSequenceKeypoint.new(0.5, Config['Bars']['Armor Bar']['Mid']),
                      ColorSequenceKeypoint.new(1, Config['Bars']['Armor Bar']['Bot']),
                  }),
                  Transparency = NumSeq({NumKey(0, 0), NumKey(1, 0)}),
              })
          ...
          do
              Objects["TargetName"] = self:CreateObjects("TextLabel", {
                  ...
                  TextSize = 12,
                  LayoutOrder = 2,
                  TextColor3 = Config['Texts']['Name']['Color'],
                  Text = "",
                  TextXAlignment = Enum.TextXAlignment.Center,
                  BorderSizePixel = 0,
                  Visible = false,
              ...
              Objects["Distance"] = self:CreateObjects("TextLabel", {
                  ...
                  TextSize = 9,
                  LayoutOrder = 2,
                  TextColor3 = Config['Texts']['Distance']['Color'],
                  Text = "",
                  TextXAlignment = Enum.TextXAlignment.Center,
                  BorderSizePixel = 0,
                  Visible = false,
              ...
              Objects["Weapon"] = self:CreateObjects("TextLabel", {
                  ...
                  TextSize = 9,
                  LayoutOrder = 3,
                  TextColor3 = Config['Texts']['Weapon']['Color'],
                  Text = "none",
                  TextXAlignment = Enum.TextXAlignment.Center,
                  BorderSizePixel = 0,
                  Visible = false,
  ...
  do
      function Library:CalculateBox(Data)
          ...
          local BoundingBox = Config['Boxes']['Bounding Box']
  ...
  do
      function Library:UpdateHealth(Data)
          ...
          if Cfg['Health']['Enabled'] then
              ...
              if not Cfg['Armor']['Enabled'] then
                  Objects['LeftBarHolder'].Visible = false
              end
          end
  
          if Cfg['Armor']['Enabled'] then
  ...
  do
      function Library:AddTarget(Player)
          ...
          local Data = {
              ...
              ['WalkActive'] = false,
              ['JumpActive'] = false,
              ['IncludeAccessories'] = Config['Boxes']['Bounding Box']['IncludeAcsessories'],
              ['LastGlowTop'] = nil,
              ['LastGlowBot'] = nil,
              ['LastGlowT1'] = nil,
              ['LastGlowT2'] = nil,
  ...
  do
      function Library:Update(Player, Data)
          ...
          local BoxesCfg = Config['Boxes']
          local TextsCfg = Config['Texts']
