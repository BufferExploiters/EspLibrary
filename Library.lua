    ...
    ---
        ...
        --
            ...
            function Library:UpdateHealth(Data)
                ...
                local Cfg = {
                    ['Health'] = Table['Bars']['Health Bar'];
                    ['Armor'] = Table['Bars']['Armor Bar'];
                };
                ...
                if Cfg['Health']['Enabled'] then
                    ...
                    local Config = {
                        ...
                        ['Ratio'] = Clamp(Humanoid.Health / Humanoid.MaxHealth, 0, 1);
                    }
                    --
                    Objects['LeftBarHolder'].Visible = true;
                    Objects['HealthBarOutline'].Visible = true;
                    Objects['HealthBar'].Size = Dim2(1, 0, Config.Ratio, 0);
                    --
                    if Config.Ratio < 1 then
                        Objects['HealthBarText'].Visible = true;
                        Objects['HealthBarText'].Text = Format('%d', Floor(Config.Health));
                        Objects['HealthBarText'].Position = Dim2(0.5, 0, 1 - Config.Ratio, 0);
                    else
